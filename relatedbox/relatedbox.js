...
(function () {
    ...
    var html = '<div class="relatedshow"><a href="#"><i class="fa fa-plus"></i></a></div><div id="related-box"><div class="header"><h2>' + conf.title + '</h2><div class="tombol"><a href="#" class="close"><i class="fa fa-times"></i></a></div></div><div class="list">',
        label = (typeof labelArray === "object" && labelArray.length) ? '/-/' + shuffle(labelArray)[0] : "",
        current = 0,
        width = 0;
    $.ajax({
        type: "GET",
        url: 'http://www.bloggerku.com/feeds/posts/summary' + label + '?max-results=' + conf.post + '&alt=json-in-script',
        async: true,
